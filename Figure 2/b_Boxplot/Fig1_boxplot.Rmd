...
Plate <- read.table(file="df_Single_Strain_OD.txt",sep="\t",dec = ".",header=TRUE)
Plate

#Subset
#Plate_72h <- subset(Plate, Time %in% c("T0", "T72"))
Plate_72h_growth <- subset(Plate_72h, Expe %in% c("Chamber"))
```
...
Extract_72 <- subset(Plate_72h_growth, Time %in% c("T72") )
...
# Calculate statistics for each condition
  statistics_by_condition <- tapply(Extract_72$Value2, Extract_72$Species, calculate_statistics)
